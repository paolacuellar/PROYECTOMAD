...
CREATE TABLE Empleado (
	...
	Rol VARCHAR(10) DEFAULT 'EM' NOT NULL, 
...
CREATE TABLE Percepcion(
	ID_Percepcion TINYINT PRIMARY KEY NOT NULL IDENTITY(1,1), 
...
CREATE TABLE Deduccion (
	ID_Deduccion TINYINT PRIMARY KEY NOT NULL IDENTITY(1,1), 
	Motivo VARCHAR(255) NOT NULL, 
	Tipo CHAR NOT NULL DEFAULT 'B', 
	Cantidad DECIMAL(10,2) NOT NULL, 
	Es_porcentaje BIT DEFAULT 0 NOT NULL
...
ALTER TABLE DatosPersonales
		ADD CONSTRAINT FK_DATOS_EMPLEADO
		FOREIGN KEY(CveEmpleado) REFERENCES Empleado(CveEmpleado);
